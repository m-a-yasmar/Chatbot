...
def ask():
    ...
    if max_score >= threshold:
        ...
        prompt = f"Answer the following question as if you're an expert on Jamaica. Do not identify yourself as an AI. If you can answer, just State that you cant answer in the most human way : {query}"
        payload = {
