...
predefined_answers = {
    ...
    'Can we have a same-sex wedding in Jamaica?': "As of my last update in January 2022, same-sex marriage is not legally recognized in Jamaica. Please consult the most current legal guidelines."
}
