...
predefined_answers = {
    ...
    'Which is the best resort area for families?': "The Ocho Rios and Montego Bay areas are generally considered family-friendly due to their wide range of activities suitable for children and adults alike. Resorts like Beaches Ocho Rios offer family-oriented amenities.",
    'Can I see two resorts when in Jamaica?': "Yes, it's possible to split your stay between two resorts. Many resorts even offer 'stay and play' deals that allow you to enjoy amenities at multiple properties.",
    'How long is the flight to Jamaica from the UK?': "From London, the flight is approximately 10 hours non-stop. For more details on flights from different locations, visit [our flight guide](#).",
    'What are child-friendly hotels in Jamaica?': "Hotels like Beaches Negril and Sunset Beach Resort in Montego Bay offer family-friendly amenities like water parks, kids' clubs, and babysitting services.",
    'How far is Royalton Negril from the airport in Montego Bay?': "Royalton Negril is approximately 80 km from Sangster International Airport in Montego Bay, usually a 90-minute drive. For travel times between various locations, visit [our travel guide](#).",
    'Is there a fee to go on a catamaran in Montego Bay?': "Yes, catamaran trips generally cost between $50 to $100 per person, depending on the length of the trip and amenities included.",
    'Can I get medical treatment if needed while in Jamaica?': "Yes, Jamaica has several hospitals and clinics. However, it's advisable to have comprehensive travel insurance. More information can be found [here](#).", 
    'Does Jamaica cater for accessibility travel?': "Many resorts and tourist attractions in Jamaica offer accessibility features, but it's best to check in advance. A detailed guide on accessibility is available [here](#).",
    'What is the cost to rent a car for 7 days in Jamaica?': "The average cost to rent a car for a week in Jamaica ranges from $250 to $500, depending on the type of vehicle and insurance coverage.",
    "Can I see Usain Bolt when I’m in Jamaica?": "While there's no guarantee you'll see Usain Bolt, you might visit his restaurant, Tracks and Records, in Kingston. However, public sightings of him are not frequent.",
    'Can I visit the Bob Marley Museum?': "Yes, the Bob Marley Museum in Kingston is open to visitors. Tickets and tour times can be found on their [official website](#).",
    'Help me to plan a 7-day itinerary to see places of interest': "Certainly! A 7-day itinerary could include Kingston (Bob Marley Museum, Devon House), Ocho Rios (Dunn's River Falls), Negril (Seven Mile Beach, Rick's Café), and Montego Bay (Rose Hall Great House). For a detailed itinerary, visit [our planning guide](#).",
    "What's the average cost of a honeymoon in Jamaica?": "The average cost can vary widely depending on the location, duration, and type of accommodations. However, expect to spend between $3,000 to $8,000. More info [here](#).",
    'Do honeymoon packages include airfare?': "Some all-inclusive packages do include airfare, but always double-check the details. Visit [our packages section](#) for options.",
    'What should we pack for our honeymoon?': "Pack casual beach attire, formal wear for romantic dinners, and essentials like sunscreen. A complete packing list can be found [here](#).",
    'What are some must-see attractions for newlyweds in Jamaica?': "Don't miss the Dunn's River Falls in Ocho Rios, Rick's Cafe in Negril, and the Blue Mountains. More suggestions are available [here](#).",
    'Any recommended local foods for newlyweds to try?': "Absolutely, try the jerk chicken, ackee and saltfish, and bammy for a taste of Jamaica. Visit [our culinary guide](#) for more.",
    'How can we ensure our safety while in Jamaica?': "Stick to tourist-friendly areas, avoid flaunting wealth, and always use reputable transportation services. A detailed safety guide can be found [here](#).",
    'What documents do we need for a wedding in Jamaica?': "You'll need a valid passport, birth certificate, and if applicable, divorce or death certificates from previous marriages. Visit [our legal guide](#) for a complete list.",
    'Are beach weddings legal in Jamaica?': "Yes, beach weddings are legal and quite popular in Jamaica. Make sure to check for any required permits or restrictions.",
...
def ask():
    ...
    if max_score >= threshold:
        ...
        prompt = f"Answer the following questions as if you're an expert on Jamaica. Do not identify yourself as an AI. If you can answer just State that you cant answer in the most human way. make your responses conversational. use the previous questions and responses to guide future responses : {query}"
        payload = {
